...
import {
  ...
  useFuncionariosRelatorio, useClientesRelatorio, useServicosRelatorio, getDefaultDates,
} from "@/hooks/useRelatorioVendasFilters";

export default function RelComissaoServico() {
  ...
  const limpar = () => {
    ...
    setDataEntregaInicio(""); setDataEntregaFim(""); setCliente(""); setServico("todos");
  ...
  const gerar = async () => {
    ...
    try {
      let query = supabase
        .from("ordem_servico")
        .select("id, numero_os, cliente_nome, data_entrada, status, valor_total_servicos, canal_venda, vendedor, criado_por")
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold">Relatório de comissão por serviço</h1>
          <p className="text-xs text-muted-foreground">Início &gt; Relatórios de vendas &gt; Comissão por serviço</p>
        </div>
      </div>
