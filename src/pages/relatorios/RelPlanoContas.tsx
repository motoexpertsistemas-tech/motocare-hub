...
export default function RelPlanoContas() {
  ...
  const limpar = () => {
    ...
    setDescricao(""); setMovimentacao("todas"); setDataInicio("2026-02-01"); setDataFim("2026-02-28");
    setCompetenciaInicio(""); setCompetenciaFim(""); setValorInicio(""); setValorFim("");
    setSituacao("todas"); setContaBancaria("todos"); setFormaPagamento("todos");
    setCentroCusto("todos"); setTransferencias(false);
  };
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold">Relatório de plano de contas</h1>
          <p className="text-xs text-muted-foreground">Início &gt; Relatórios financeiros &gt; Plano de contas</p>
        </div>
      </div>

      <Card>
        <CardContent className="pt-6 space-y-4">
          {/* Linha 1: Loja, Entidade, Cliente */}
          ...
          {/* Linha 2: Plano de contas, Descrição, Movimentação */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="space-y-1.5">
          ...
          {/* Linha 3: Período, Data de competência */}
          ...
          {/* Linha 4: Valor, Situação, Conta bancária */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="space-y-1.5">
              <Label>Valor</Label>
              <div className="flex items-center gap-2">
          ...
          {/* Linha 5: Forma de pagamento, Centro de custo */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="space-y-1.5">
