...
export default function RelProdutosVendidos() {
  ...
  const limpar = () => {
    ...
    setVendedor("todos"); setSituacao("todos"); setCanal("todos"); setFornecedor(""); setCentroCusto("todos");
    setFormaPagamento("todos"); setConsiderarFrete("sim"); setConsiderarDevolucoes(false);
  ...
  const gerar = async () => {
    ...
    try {
      ...
      if (produto) filtered = filtered.filter((r: any) => JSON.stringify(r).toLowerCase().includes(produto.toLowerCase()));
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold">Relatório de produtos vendidos</h1>
          <p className="text-xs text-muted-foreground">Início &gt; Relatórios de vendas &gt; Produtos vendidos</p>
        </div>
      </div>
      ...
      {semResultados && (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-lg font-semibold text-muted-foreground">Nenhum produto vendido encontrado</p>
