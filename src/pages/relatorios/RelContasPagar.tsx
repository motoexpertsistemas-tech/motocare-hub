...
import { ArrowDownLeft, Check, X, ArrowLeft } from "lucide-react";
...
export default function RelContasPagar() {
  ...
  const limpar = () => {
    setLoja("todas"); setEntidade("fornecedor"); setFornecedor(""); setPlanoContas("todos");
    ...
    setSituacao("todas"); setContaBancaria("todos"); setFormaPagamento("todos"); setCentroCusto("todos");
    setDetalhado(false); setTransferencias(false);
  };
    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-muted-foreground">Início &gt; Relatórios financeiros &gt; Contas a pagar</p>
        </div>
      </div>
      ...
      <Card>
        <CardContent className="pt-6 space-y-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>{entidade === "fornecedor" ? "Fornecedor" : "Cliente"}</Label>
              {entidade === "fornecedor" ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div className="space-y-1.5">
              <Label>Valor</Label>
              <div className="flex items-center gap-2">
                <Input value={valorInicio} onChange={(e) => setValorInicio(e.target.value)} />
                <span className="text-xs text-muted-foreground">a</span>
                <Input value={valorFim} onChange={(e) => setValorFim(e.target.value)} />
              </div>
            </div>
          </div>
