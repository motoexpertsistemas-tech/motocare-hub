...
export default function RelProdutosDevolvidos() {
  ...
  const limpar = () => {
    ...
    setCliente(""); setGrupo("todos"); setProduto(""); setVendedor("todos"); setSituacao("todos");
    setCanal("todos"); setFornecedor(""); setCentroCusto("todos"); setConsiderarFrete("sim");
  ...
  const gerar = async () => {
    ...
    try {
      ...
      toast.success(`${filtered.length} produtos devolvidos encontrados!`);
    } catch (err: any) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold">Relatório de produtos devolvidos</h1>
          <p className="text-xs text-muted-foreground">Início &gt; Relatórios de vendas &gt; Produtos devolvidos</p>
        </div>
      </div>
      ...
      {semResultados && (
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-lg font-semibold text-muted-foreground">Nenhum produto devolvido encontrado</p>
