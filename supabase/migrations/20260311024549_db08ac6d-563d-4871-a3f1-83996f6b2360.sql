...
-- Function to create e-commerce customer with hashed password
CREATE OR REPLACE FUNCTION public.criar_cliente_ecommerce(
  p_loja_id uuid,
  p_nome text,
  p_email text,
...
BEGIN
  ...
  VALUES (p_loja_id, p_nome, p_email, p_telefone, p_cpf, crypt(p_senha, gen_salt('bf')))
  RETURNING id INTO new_id;
  RETURN new_id;
END;
$$;

-- Function to verify e-commerce customer password
